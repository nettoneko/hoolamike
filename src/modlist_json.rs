...
#[serde(tag = "$type")]
#[serde(deny_unknown_fields)]
#[enum_kind(DirectiveKind, derive(Serialize, Deserialize, PartialOrd, Ord, derive_more::Display))]
pub enum Directive {
    CreateBSA(directive::UnknownDirective),
    FromArchive(directive::UnknownDirective),
    InlineFile(directive::UnknownDirective),
    PatchedFromArchive(directive::UnknownDirective),
    RemappedInlineFile(directive::UnknownDirective),
    TransformedTexture(directive::UnknownDirective),
}
